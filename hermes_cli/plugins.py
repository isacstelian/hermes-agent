...
VALID_HOOKS: Set[str] = {
    ...
    # Confirmed outbound-message observer. The v1 fire-site covers successful
    # generated cron text sent through the live Telegram adapter only. Other
    # gateway messages do not emit this hook yet. Return values are ignored.
