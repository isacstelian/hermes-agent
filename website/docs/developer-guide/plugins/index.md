...
| [`gateway_message_delivered`](/user-guide/features/hooks#gateway_message_delivered) | A live Telegram cron text message is confirmed delivered | `source: "cron", execution_id: str, job_id: str, platform: "telegram", chat_id: str, thread_id: str \| None, message_id: str` | ignored |
