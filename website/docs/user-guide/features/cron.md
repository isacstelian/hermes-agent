...
hermes cron feedback <job_id> --limit 50
```

Feedback collection does not rewrite routine prompts automatically. Use the
report as evidence for a reviewed improvement loop.
