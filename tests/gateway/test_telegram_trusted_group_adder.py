...
def test_my_chat_member_handler_is_registered_on_each_application(monkeypatch):
    ...
    # 8 = text, command, location, media, callback, MIGRATE, my_chat_member,
    # plus main's gateway_platform_event TypeHandler observer (#64176).
    assert first_app.add_handler.call_count == 8
